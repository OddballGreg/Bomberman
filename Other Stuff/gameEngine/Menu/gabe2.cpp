...
public:
    ExampleApplication() : nanogui::Screen(Eigen::Vector2i(1024, 768), "Bomberman!") {
        using namespace nanogui;

        Window *window = new Window(this, "Button Menu");
        ...
        window = new Window(this, "Widgets Menu");
        ...
        window = new Window(this, "Misc. widgets Menu");
